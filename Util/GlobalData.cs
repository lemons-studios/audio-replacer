...
namespace AudioReplacer.Util
{
    public static class GlobalData
    {
        ...
        [
            ...
            ["-filter:a \"[0:a]asplit[out1][out2];[out1]volume=0.3[out1mod];[out2]volume=1.2,rubberband=pitch=0.8[out2mod];[out1mod][out2mod]amix=inputs=2:weights=1 3\"", "Shadow Self"], 
